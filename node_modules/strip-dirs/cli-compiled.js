...
function help() {
  ...
  console.log([sumUp(pkg), '', 'Usage 1: $ strip-dirs <string> --count(or -c) <number> [--narrow(or -n)]', 'Usage 2: $ echo <string> | strip-dirs --count(or -c) <number> [--narrow(or -n)]', '', 'Flags:', yellow('--count,   -c') + '  Number of directories to strip from the path', yellow('--narrow,  -n') + '  Disallow surplus count of directory level', yellow('--version, -v') + '  Print version', yellow('--help,    -h') + '  Print usage information'].join('\n'));
}
