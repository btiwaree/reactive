...
module.exports = function stripDirs(pathStr, count, option) {
  ...
  if (typeof pathStr !== 'string') {
    throw new TypeError(pathStr + ' is not a string. First argument to strip-dirs must be a path string.');
  }
  ...
  if (!isNaturalNumber(count, true)) {
    throw new Error('Second argument to strip-dirs must be a natural number or 0.');
  }
