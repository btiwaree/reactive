...
(function (global) {
    ...
    var convertUTF16ArrayToUTF8Array = function (uni) {
        ...
        for (var i = 0, l = uni.length; i < l; i++) {
            var n = uni[i];
            if (n < 0x80) bin.push(n);else if (n < 0x800) bin.push(0xc0 | n >>> 6, 0x80 | n & 0x3f);else bin.push(0xe0 | n >>> 12 & 0x0f, 0x80 | n >>> 6 & 0x3f, 0x80 | n & 0x3f);
        }
        return bin;
    };
...
//# sourceMappingURL=base64-1.7-compiled.js.map