	...
	processCss(content, map, {
		...
		var importJs = result.importItems.filter(function (imp) {
			...
			if (!loaderUtils.isUrlRequest(imp.url, root)) {
				return "exports.push([module.id, " + JSON.stringify("@import url(" + imp.url + ");") + ", " + JSON.stringify(imp.mediaQuery) + "]);";
			} else {
		...
		function importItemMatcher(item) {
			...
			return "\" + require(" + loaderUtils.stringifyRequest(this, importUrl) + ").locals" + "[" + JSON.stringify(importItem.export) + "] + \"";
		}
