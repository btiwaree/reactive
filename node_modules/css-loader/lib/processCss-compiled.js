...
module.exports = function processCss(inputSource, inputMap, options, callback) {
	...
	var pipeline = postcss([localByDefault({
		mode: options.mode,
	...
	}), extractImports(), modulesValues, modulesScope({
	...
	if (minimize) {
		...
		["zindex", "normalizeUrl", "discardUnused", "mergeIdents", "reduceIdents"].forEach(function (name) {
			if (typeof minimizeOptions[name] === "undefined") minimizeOptions[name] = false;
		});
...
//# sourceMappingURL=processCss-compiled.js.map