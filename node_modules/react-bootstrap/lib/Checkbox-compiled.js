...
var Checkbox = function (_React$Component) {
  ...
  Checkbox.prototype.render = function render() {
    ...
    if (inline) {
      ...
      return _react2['default'].createElement('label', { className: _classnames2['default'](className, _classes2), style: style }, _react2['default'].createElement('input', _extends({}, props, { type: 'checkbox', disabled: disabled })), children);
    }
    ...
    return _react2['default'].createElement('div', { className: _classnames2['default'](className, classes), style: style }, _react2['default'].createElement('label', null, _react2['default'].createElement('input', _extends({}, props, { type: 'checkbox', disabled: disabled })), children));
  };
