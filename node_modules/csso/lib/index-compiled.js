...
function minify(context, source, options) {
    ...
    // parse
    var ast = debugOutput('parsing', options, Date.now(), parse(source, context, {
        filename: filename,
    ...
    // compress
    var compressedAst = debugOutput('compress', options, Date.now(), compress(ast, buildCompressOptions(options)));
    ...
    if (options.sourceMap) {
        ...
        result = debugOutput('translate', options, Date.now(), traslateInternal(compressedAst));
    }
